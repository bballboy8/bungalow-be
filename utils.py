...
def latlon_to_geojson(lat, lon, range_meters):
    ...
    delta_lat = range_meters / R
    delta_lon = range_meters / (R * math.cos(math.radians(lat)))
    ...
    north_lat = lat + delta_lat_deg
    south_lat = lat - delta_lat_deg
    east_lon = lon + delta_lon_deg
    west_lon = lon - delta_lon_deg
